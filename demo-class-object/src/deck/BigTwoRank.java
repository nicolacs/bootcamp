...
public class BigTwoRank extends NewRank {
...
public static void main(String[] args) {
    NewRank two = BigTwoRank.ofTWO();
    NewRank ace = BigTwoRank.ofACE();
    System.out.println(two.compareTo(ace)); // 1

    NewRank two2 = PokerRank.ofTWO();
    NewRank ace2 = PokerRank.ofACE();
    System.out.println(two2.compareTo(ace2)); // -1


    BigTwoRank b1 = new BigTwoRank(10);
    BigTwoRank b2 = new BigTwoRank(3);
